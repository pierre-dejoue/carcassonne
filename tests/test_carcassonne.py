...
class TestPlacedTile(unittest.TestCase):
    ...
    def test_segment_labels(self):
        placed_tile = PlacedTile(self.test_tile, 2, 1, r = 0, segment = (42, 1, 2))
        ...
        placed_tile = PlacedTile(self.test_tile, 2, 1, r = 1, segment = (42, 1, 2))
        ...
        placed_tile = PlacedTile(self.test_tile, 2, 1, r = 0, segment = (42, 1, 0))
